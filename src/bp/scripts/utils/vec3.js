...
export class Vec3 {
	...
	static forward = Object.freeze({
		x: 0,
		y: 0,
		z: 1,
	});
	static backward = Object.freeze({
		x: 0,
		y: 0,
		z: -1,
	});
	 ...
	 */
	static create(primary, fallback) {
	 ...
	 */
	static randomLocationInSphere(sphereRadius) {
	 ...
	 */
	static generateOnCircle(radius, numberOfPoints) {
		const vectors = [];
	 ...
	 */
	static rotateRad(vec, axis, radians) {
	 ...
	 * @returns The rotated vector.
	 */
	static rotateDeg(vec, axis, degrees) {
	 ...
	 */
	static getRelativeToHead(headLocation, viewDirection, move) {
	 ...
	 */
	static stringify(value, format = 0) {
