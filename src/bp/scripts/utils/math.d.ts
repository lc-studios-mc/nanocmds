 ...
 */
export declare const almostEquals: (n1: number, n2: number, epsilon?: number) => boolean;
/**
 ...
 */
export declare const randi: (min: number, max: number) => number;
/**
 ...
 */
export declare const resolveRangeFloat: (range?: number | Range, fallback?: number) => number;
/**
 ...
 */
export declare const resolveRangeInt: (range?: number | Range, fallback?: number) => number;
